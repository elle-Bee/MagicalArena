...
/**
 * The ArenaTest class contains test methods for the Arena and Player classes.
 */
public class ArenaTest {
    ...
    /**
     * Tests the fight between players.
     */
    public static void testFight() {
        try {
            ...
            System.err.println("testFight failed: " + e.getMessage());
        }
    }

    /**
     * Tests a single round of attack and defense.
     */
    public static void testRoundExecution() {
        try {
            ...
            System.err.println("testRoundExecution failed: " + e.getMessage());
        }
    }
}